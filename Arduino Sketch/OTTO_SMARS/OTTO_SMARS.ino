...
int lSpeed = 200; // motor speed (higher is faster)
int rSpeed = 200; // motor speed (higher is faster)
...
void setup() {
  ...
  Serial.begin(38400);  // for default Bluetooth module use:  Serial.begin(9600);
  newmouth = 0;
